          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div>
              ...
              <div className="mt-4 space-y-4">
                <Link href={`/${lang}/about`} className="text-base text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white block">
                  About Us
                </Link>
                <Link href={`/${lang}/features`} className="text-base text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white block">
                  Features
                </Link>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="mt-4 space-y-4">
                <Link href={`/${lang}/privacy`} className="text-base text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white block">
                  Privacy
                </Link>
                <Link href={`/${lang}/terms`} className="text-base text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white block">
                  Terms
                </Link>
              </div>
            </div>
            ...
            <div>
              <h3 className="text-sm font-semibold text-gray-900 dark:text-white uppercase tracking-wider">Security</h3>
              <div className="mt-4 space-y-4">
                <Link href={`/${lang}/security`} className="text-base text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white block">
                  Security Center
                </Link>
              </div>
            </div>
